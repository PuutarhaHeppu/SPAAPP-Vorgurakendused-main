<template>
  ...
  const showDetails = (EventPeople: EventPeople) => {
    selectedEventPeople.value = EventPeople;
  ...
  const remove = (EventPeople: EventPeople) => {
    EventPeopleStore.deleteEventPeople(EventPeople);
  };
  ...
  .popupClose {
    ...
    padding: 0; /* Remove padding to prEventPeople misalignment */
  }
